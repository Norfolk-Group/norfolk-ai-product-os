...
const contractGlobs = ["governance/*.md", "decisions/*.md", "product/*.md", "design/*.md", "catalog/*.md", "migration/*.md", "adoption/*.md", "outputs/{README,shared-principles,job-lifecycle,presentation-ir,pdf,xlsx,pptx,docx,email,charts,print,investor-materials}.md", "playbooks/*.md", "standards/*.md", "templates/*.md"];
