...
Every capability map records user vocabulary, procedure, callers, authorization, approval, context availability, completion signal, and recovery. A UI-only exception must name the physical, legal, or security reason and a human path. “We did not build the tool” is not an exception.
