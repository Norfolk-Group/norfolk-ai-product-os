...
Product-level asset libraries, three-choice transformations, portraits, logo processing, factual property imagery, sharing approval, and reference-aware deletion follow [Identity and media assets](../design/asset-experience.md). The machine-readable workflow is [`media-asset-workflow.schema.json`](../schemas/media-asset-workflow.schema.json).
